<html>
	...
	<body>
		<main>
            ...
            <div class="mb-3">
						  <label for="exampleFormControlTextarea1" class="form-label">Stock Disponible</label>
						  <input name="stockDisponible" type="number" class="form-control" id="exampleFormControlTextarea1" maxlength="7">
						</div>
